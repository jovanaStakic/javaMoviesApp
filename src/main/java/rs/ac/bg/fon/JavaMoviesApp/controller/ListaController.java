...
public class ListaController {
    ...
    @PostMapping
    public ResponseEntity<ListaDto> createLista(@RequestBody ListaDto listaDto, @AuthenticationPrincipal String username) {
        Korisnik korisnik = (Korisnik) korisnikService.loadUserByUsername(username);
        listaDto.setKorisnikId(korisnik.getId());
    ...
    public ResponseEntity<List<ListaDto>> getAllListe(@AuthenticationPrincipal String username) {
        ...
        List<ListaDto> listaDtos = liste.stream()
    ...
    public ResponseEntity<ListaDto> updateLista(@PathVariable Long listaId,@RequestBody ListaDto listaDto, @AuthenticationPrincipal String username) {
        Korisnik korisnik = (Korisnik) korisnikService.loadUserByUsername(username);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteLista(@PathVariable Long id, @AuthenticationPrincipal String username) {
        Korisnik korisnik = (Korisnik) korisnikService.loadUserByUsername(username);
